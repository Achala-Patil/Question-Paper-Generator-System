...
<head>
    ...
    <style>
        body {
            background-image: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('questionback2.jpg');
        ...
        <div class="frame">
            ...
            <div ng-app ng-init="checked = false">
                <form class="form-signin" style="border: none;" action="" method="post" name="form">
                    ...
                    <input id=myButton style="background-color:#3d7fa8"  class="admin" name="AdminLogin"
                        value="Admin Login" />
            ...
            <script>
                ...
                button.addEventListener("click", function () {
                    // Change the location to the desired webpage
