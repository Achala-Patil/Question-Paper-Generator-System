...
$username = "Admin"; // Replace with your logic to fetch the username
?>
...
<head>
    ...
    <script>
        // Function to show alert when the forgotten password button is clicked
...
<body>
    ...
    <main>
        <section>
            ...
            <div id="imageSlider" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="../vit_image.jpg" class="d-block w-100" alt="Image 1">
                    </div>
            ...
            <!-- <button type="button" class="btn btn-warning mt-3" onclick="showForgotPasswordAlert()">Forgotten Password?</button>-->
        </section>
    </main>
